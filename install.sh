...
pwsh -Command "IEX (IWR 'https://raw.githubusercontent.com/ivanba-arch/redteam/main/install-atomicredteam.ps1' -UseBasicParsing); Install-AtomicRedTeam -getAtomics" -Force > /tmp/pwsh_output.log 2>&1
